...
public interface Event extends Comparable<Event>, Documentation {
	 ...
	 * @throws PrefilterNonMatchException Equivalent
	 ...
	 * @throws EventException If some exception occurs
	 * during map building
     */
	 ...
	 * @throws EventException If the event isn't cancellable
     */
     ...
     */
    public void execute(ParseTree s, BoundEvent b, Environment env, BoundEvent.ActiveEvent activeEvent) throws EventException;
