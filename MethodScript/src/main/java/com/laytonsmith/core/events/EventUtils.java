...
public final class EventUtils {
	...
	public static void FireListeners(SortedSet<BoundEvent> toRun, Event driver, BindableEvent e) {
		...
		for (BoundEvent b : toRun) {
			if (activeEvent.canReceive() || b.getPriority().equals(BoundEvent.Priority.MONITOR)) {
				try {
	 ...
	 *
	 * @param mce
	 * @deprecated Use {@link #TriggerListener(com.laytonsmith.core.events.Driver, java.lang.String, BindableEvent)} instead
	 */
	@Deprecated
