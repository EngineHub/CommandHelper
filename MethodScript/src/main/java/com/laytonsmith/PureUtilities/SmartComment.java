...
public class SmartComment {
	 ...
	 * Creates a new smart comment. 
	 * @param comment The comment to be parsed
	 * @param replacements This is used to replace embedded annotations with some
	 * other text. For instance, if the comment contained { @ code myCode }, (minus spaces) it may be used to 
	 * return "&lt;code&gt;myCode&lt;/code&gt;". By default, if a particular embedded annotation
	 * has no handler, the embedded text is simply used as is.
	 */
