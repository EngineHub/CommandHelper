...
/**
 * A ConnectionMixin class dictates how a data source connects to its data. This can vary depending on the URI, and so
...
public class ConnectionMixinFactory {
	...
	public static class ConnectionMixinOptions {
		...
		/**
		 * In the case of file based connections, this is the working directory, that is, the "." directory used to
