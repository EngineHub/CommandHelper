...
import com.laytonsmith.puls3.core.Installer;
 ...
 * @author sk89q
 */
public class Puls3Plugin extends JavaPlugin {
    ...
    public static Puls3Plugin self;
    public static WorldEditPlugin wep;
    /**
     * Listener for the plugin system.
     */
    final Puls3Listener playerListener =
            new Puls3Listener(this);
    
    /**
     * Interpreter listener
     */
    final Puls3InterpreterListener interpreterListener = 
            new Puls3InterpreterListener();
    /**
     * Server Command Listener, for console commands
     */
    final Puls3ServerListener serverListener =
            new Puls3ServerListener();
    ...
    public void onEnable() {
        ...
        logger.info("Puls3/CommandHelper " + getDescription().getVersion() + " enabled");
    ...
    private boolean runCommand(final MCPlayer player, String cmd, String[] args) {
        Puls3Session session = playerListener.getSession(player);
        ...
        // Save alias
            ...
            if(args.length > 0){
                ...
                String alias = Puls3Plugin.joinString(args, " ");
                try {
