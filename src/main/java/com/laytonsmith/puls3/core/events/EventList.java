...
public class EventList {
    ...
    private static void initEvents() {
        ...
        if((Boolean)com.laytonsmith.puls3.core.Static.getPreferences().getPreference("debug-mode")){
            System.out.println("Puls3: Loaded " + total + " event" + (total==1?"":"s"));
        }
    }
            ...
            if(EventHandlerInterface.class.isAssignableFrom(c)){
                 if(Event.class.isAssignableFrom(load)){
                    ...
                    if(!apiClass.equals("Sandbox")){
                        if((Boolean)com.laytonsmith.puls3.core.Static.getPreferences().getPreference("debug-mode")){
                            System.out.println("Puls3: Loaded event \"" + e.getName() + "\"");
                        }
                    }
                    ...
                    try{
                     ...
                     System.out.println("Puls3: Loaded event " + load.getSimpleName() + " must implement Event");
                 }
            } else {
                System.out.println("Puls3: Loaded event " + c.getSimpleName() + " must implement AbstractEventHandler");
            }
        }
    }
     ...
     */
    public static void Startup(Puls3Plugin chp){
