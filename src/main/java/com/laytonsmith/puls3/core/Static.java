...
import com.laytonsmith.puls3.abstraction.MCEntity;
...
import com.laytonsmith.puls3.core.functions.Debug;
...
public class Static {
    ...
    public static Logger getLogger() throws NotInitializedYetException {
        Logger l = com.laytonsmith.puls3.Puls3Plugin.logger;
        if (l == null) {
    ...
    public static MCServer getServer() throws NotInitializedYetException {
        MCServer s = com.laytonsmith.puls3.Puls3Plugin.myServer;
        if (s == null) {
    ...
    public static AliasCore getAliasCore() throws NotInitializedYetException {
        AliasCore ac = com.laytonsmith.puls3.Puls3Plugin.getCore();
        if (ac == null) {
    ...
    public static SerializedPersistance getPersistance() throws NotInitializedYetException {
        SerializedPersistance p = com.laytonsmith.puls3.Puls3Plugin.persist;
        if (p == null) {
    ...
    public static PermissionsResolverManager getPermissionsResolverManager() throws NotInitializedYetException {
        PermissionsResolverManager prm = com.laytonsmith.puls3.Puls3Plugin.perms;
        if (prm == null) {
    ...
    public static Version getVersion() throws NotInitializedYetException {
        Version v = com.laytonsmith.puls3.Puls3Plugin.version;
        if (v == null) {
    ...
    public static Preferences getPreferences() throws NotInitializedYetException {
        if (com.laytonsmith.puls3.Puls3Plugin.prefs == null) {
            ArrayList<Preferences.Preference> a = new ArrayList<Preferences.Preference>();
            //a.add(new Preference("check-for-updates", "false", Type.BOOLEAN, "Whether or not to check to see if there's an update for Puls3"));
            ...
            a.add(new Preference("play-dirty", "false", Type.BOOLEAN, "Makes Puls3 play dirty and break all sorts of programming rules, so that other plugins can't interfere with the operations that you defined. Note that doing this essentially makes Puls3 have absolute say over commands. Use this setting only if you can't get another plugin to cooperate with CH, because it is a global setting."));
            ...
            com.laytonsmith.puls3.Puls3Plugin.prefs = new Preferences("CommandHelper", getLogger(), a);
        }
        return com.laytonsmith.puls3.Puls3Plugin.prefs;
    }
    ...
    /**
     * Sets up Puls3 to play-dirty, if the user has specified as such
     */
