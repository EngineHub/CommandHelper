...
import com.laytonsmith.puls3.abstraction.MCGameMode;
import com.laytonsmith.puls3.abstraction.MCInventory;
...
import com.laytonsmith.puls3.core.constructs.CDouble;
import com.laytonsmith.puls3.core.constructs.CInt;
import com.laytonsmith.puls3.core.constructs.CNull;
...
public class PlayerManagement {
    ...
    public static class player implements Function {
        ...
        public Construct exec(int line_num, File f, Env env, Construct... args) throws CancelCommandException, ConfigRuntimeException {
            ...
            } else if (p instanceof MCConsoleCommandSender) {
        ...
        public String docs() {
            return "string {[MCPlayerName]} Returns the full name of the partial MCPlayer name specified or the MCPlayer running the command otherwise. If the command is being run from"
    ...
    public static class set_display_name implements Function {
        ...
        public String docs() {
            return "void {MCPlayerName, newDisplayName | newDisplayName} Sets a MCPlayer's display name. If the second usage is used,"
                    ...
                    + " as all Puls3 commands expect the MCPlayer's real name, not their display name.";
        }
