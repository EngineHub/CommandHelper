...
//            }
    ...
    @api public static class console implements Function{
        ...
        public String docs() {
            return "void {message, [prefix]} Logs a message to the console. If prefix is true, prepends \"Puls3:\""
        ...
        public Construct exec(int line_num, File f, Env env, Construct... args) throws CancelCommandException, ConfigRuntimeException {
            ...
            com.laytonsmith.puls3.core.Static.getLogger().log(Level.INFO, (prefix?"Puls3: ":"") + mes);
            return new CVoid(line_num, f);
        }
        public Boolean runAsync(){
            return null;
