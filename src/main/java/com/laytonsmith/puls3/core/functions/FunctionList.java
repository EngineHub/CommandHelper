...
import com.laytonsmith.puls3.core.constructs.CFunction;
...
//        }
        ...
        if((Boolean)com.laytonsmith.puls3.core.Static.getPreferences().getPreference("debug-mode")){
            System.out.println("Puls3: Loaded " + functions.size() + " function" + (functions.size()==1?"":"s"));
        }
    ...
    public static void registerFunction(Function f, String apiClass) {
        if(!apiClass.equals("Sandbox")){
            if((Boolean)com.laytonsmith.puls3.core.Static.getPreferences().getPreference("debug-mode")){
                System.out.println("Puls3: Loaded function \"" + f.getName() + "\"");
            }
        }
        try{
