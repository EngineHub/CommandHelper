...
import com.laytonsmith.puls3.core.events.BoundEvent;
import com.laytonsmith.puls3.core.events.Event;
    ...
    @api public static class trigger implements Function{
        ...
        public String docs() {
            return "void {eventName, eventObject, [serverWide]} Manually triggers bound events. The event object passed to this function is "
                    ...
                    + " If serverWide is true, the event is triggered directly in the server, unless it is a Puls3 specific"
                    + " event, in which case, serverWide is irrelevant. Defaults to false, which means that only Puls3 code"
