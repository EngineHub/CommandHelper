...
public class APIBuilder {
    ...
    /**
     * Returns a Map that can be converted into a json (or used for other purposes), which
     * provides various information about the entire API, including known extensions.
     * @return
     */
