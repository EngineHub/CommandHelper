...
public abstract class SQLProfile extends Profiles.Profile {
	...
	/**
	 * Returns true if the query calls for autogenerated keys to be returned. By default,
	 * we return true, because most database systems can handle having it always
	 * be true, but some database systems will fail on things like SELECT statements
	 * if autogenerated keys are requested on non-INSERT statements.
