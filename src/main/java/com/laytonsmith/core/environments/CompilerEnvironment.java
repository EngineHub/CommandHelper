...
/**
 * A CompilerEnvironment is available only at compile time, and contains compilation specific data.
 */
public class CompilerEnvironment implements Environment.EnvironmentImpl, Cloneable {
	...
	/**
	 * Returns the ivariable from the lowest stack element. If the IVariable is not defined, null is returned.
	 *
	 * @param name
	 * @return
	 */
