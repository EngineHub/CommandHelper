...
public class ArrayHandling {
	...
	@Override
	public String docs() {
	    return "boolean {array, index...} Checks to see if the specified array has an element at index. If more than one index is specified, then it"
		    + " recursively checks down nested arrays.";
	}
