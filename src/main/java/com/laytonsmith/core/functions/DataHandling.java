...
//		}
	...
	public static class include extends AbstractFunction implements Optimizable, DocumentLinkProvider {
		...
		@Override
		public CVoid execs(Target t, Environment env, Script parent, GenericParameters generics, ParseTree... nodes) {
...
//				}
	...
	public static class is_closure extends AbstractFunction {
		...
		@Override
		public Mixed exec(Target t, Environment env, GenericParameters generics, Mixed... args) throws ConfigRuntimeException {
			return CBoolean.get(args[0].isInstanceOf(CClosure.TYPE, null, env));
		}
