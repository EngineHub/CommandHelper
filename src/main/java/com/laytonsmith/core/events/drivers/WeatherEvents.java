...
public class WeatherEvents {
	...
	public static class lightning_strike extends AbstractEvent {
		...
		@Override
		public String docs() {
			return "{world: <macro> the world | location: <location match> the lightning strike location"
	...
	public static class thunder_change extends AbstractEvent {
		...
		@Override
		public String docs() {
			return "{world: <macro> the world | has_thunder: <boolean match> if it is thundering}"
	...
	public static class weather_change extends AbstractEvent {
		...
		@Override
		public String docs() {
			return "{world: <macro> the world | has_rain: <boolean match> if it is raining}"
