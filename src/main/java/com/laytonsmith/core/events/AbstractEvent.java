...
/**
 * This helper class implements a few of the common functions in event, and most
...
//
    ...
    /**
     * If the event needs to run special code when a player unbinds the event,
     * it can be done here. By default, an UnsupportedOperationException is
     * thrown, but is caught and ignored.
     */
    @Override
    ...
    /**
     * This method is called before the event handling code is run, and provides
     * a place for the event code itself to modify the environment or active
     * event data.
     *
     * @param env The environment, at the time just before the event handler is
     * called.
    ...
    /**
     * This method is called after the event handling code is run, and provides
     * a place for the event code itself to modify or cleanup the environment or
     * active event data.
     *
     * @param env The environment, at the time just before the event handler is
     * called.
     * @param activeEvent The event handler code.
     * @throws UnsupportedOperationException If the preExecution isn't
     * supported, this may be thrown, and it will be ignored.
     */
    ...
    /**
     * For sorting and optimizing events, we need a comparison operation. By
     * default it is compared by looking at the event name.
     *
     * @param o
     * @return
     */
    ...
    /**
     * If it is ok to by default do a simple conversion from a CArray to a Map,
     * this method can do it for you. Likely this is not acceptable, so
     * hard-coding the conversion will be necessary.
     *
     * @param manualObject
     * @return
     */
     ...
     * handler. If this is not the desired behavior, this method can be
     * overridden in the actual event (if it's an external event, for instance)
     *
     * @param o
     */
    @Override
    ...
    /**
     * Most events should return true for this, but passive events may override
     * this to return null.
     *
     * @return
     */
