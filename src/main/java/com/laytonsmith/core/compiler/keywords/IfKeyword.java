...
public class IfKeyword extends Keyword {
	...
	@Override
	public String docs() {
		return "Creates an if block. Often used in combination with else/else if chains,"
				+ " provides a way to conditionally execute code depending on the true or"
				+ " false value of the condition.";
	}
