...
public class CByteArray extends CArray implements Sizeable, ArrayAccess {
	 ...
	 * instead simply wrapped, meaning changes to the underlying byte array will be reflected in the CByteArray created,
	 * and vice versa.
	 *
	 * @param b
	 * @param t
	...
	/**
	 * Creates a new, empty CByteArray, with initial capacity set as specified.
	 *
	 * @param t
	 * @param capacity
	 */
	...
	/**
	 * Returns a byte array, of the given size, read from pos, or the current position, if null.
	 *
	 * @param size
	 * @param pos
	 * @return
	...
	/**
	 * Writes out a UTF-8 encoded string to the buffer. First, it writes out a short representing the length of the
	 * string.
	 *
	 * @param string
	 * @param pos
	...
	/**
	 * Reads in a UTF-8 encoded string. It is assumed that the string begins with a 16 bit length marker.
	 *
	 * @param pos
	...
	/**
	 * Returns a copy of this CByteArray, as a Java byte array, at this point in time. This is meant to be used as the
	 * final step before sending the data off to an external process, or when interfacing mscript with other POJO code.
	 *
	 * @return
	 */
