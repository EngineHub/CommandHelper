...
/**
 * A target allows code to be exactly identified in source. It contains the line number, file,
 * and column that this target represents.
 * @author layton
 */
public class Target {
     ...
     * you must use this target instead. If a null target is attempted to be created
