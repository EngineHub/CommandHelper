...
public abstract class MCMaterial<Concrete> extends DynamicEnum<MCVanillaMaterial, Concrete> implements AbstractionObject {
	...
	public enum MCVanillaMaterial {
		...
		// 1.19.3 additions
		ENDER_DRAGON_SPAWN_EGG(MCVersion.MC1_19_X),
		IRON_GOLEM_SPAWN_EGG(MCVersion.MC1_19_X),
		SNOW_GOLEM_SPAWN_EGG(MCVersion.MC1_19_X),
		WITHER_SPAWN_EGG(MCVersion.MC1_19_X),

		// 1.19.3 experimental additions (enabled with feature flag on this version)
		BAMBOO_BLOCK(MCVersion.MC1_19_X),
		BAMBOO_BUTTON(MCVersion.MC1_19_X),
		BAMBOO_DOOR(MCVersion.MC1_19_X),
		BAMBOO_FENCE(MCVersion.MC1_19_X),
		BAMBOO_FENCE_GATE(MCVersion.MC1_19_X),
		BAMBOO_MOSAIC(MCVersion.MC1_19_X),
		BAMBOO_PLANKS(MCVersion.MC1_19_X),
		BAMBOO_PRESSURE_PLATE(MCVersion.MC1_19_X),
		BAMBOO_RAFT(MCVersion.MC1_19_X),
		BAMBOO_CHEST_RAFT(MCVersion.MC1_19_X),
		BAMBOO_SIGN(MCVersion.MC1_19_X),
		BAMBOO_SLAB(MCVersion.MC1_19_X),
		BAMBOO_MOSAIC_SLAB(MCVersion.MC1_19_X),
		BAMBOO_STAIRS(MCVersion.MC1_19_X),
		BAMBOO_MOSAIC_STAIRS(MCVersion.MC1_19_X),
		BAMBOO_TRAPDOOR(MCVersion.MC1_19_X),
		STRIPPED_BAMBOO_BLOCK(MCVersion.MC1_19_X),
		CHISELED_BOOKSHELF(MCVersion.MC1_19_X),
		PIGLIN_HEAD(MCVersion.MC1_19_X),
		PIGLIN_WALL_HEAD(MCVersion.MC1_19_X),
		ACACIA_HANGING_SIGN(MCVersion.MC1_19_X),
		BAMBOO_HANGING_SIGN(MCVersion.MC1_19_X),
		BIRCH_HANGING_SIGN(MCVersion.MC1_19_X),
		CRIMSON_HANGING_SIGN(MCVersion.MC1_19_X),
		DARK_OAK_HANGING_SIGN(MCVersion.MC1_19_X),
		JUNGLE_HANGING_SIGN(MCVersion.MC1_19_X),
		MANGROVE_HANGING_SIGN(MCVersion.MC1_19_X),
		OAK_HANGING_SIGN(MCVersion.MC1_19_X),
		SPRUCE_HANGING_SIGN(MCVersion.MC1_19_X),
		WARPED_HANGING_SIGN(MCVersion.MC1_19_X),
		BAMBOO_WALL_SIGN(MCVersion.MC1_19_X),
		ACACIA_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		BAMBOO_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		BIRCH_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		CRIMSON_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		DARK_OAK_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		JUNGLE_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		MANGROVE_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		OAK_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		SPRUCE_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		WARPED_WALL_HANGING_SIGN(MCVersion.MC1_19_X),
		CAMEL_SPAWN_EGG(MCVersion.MC1_19_X);
