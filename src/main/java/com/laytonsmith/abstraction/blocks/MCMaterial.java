...
public abstract class MCMaterial<Concrete> extends DynamicEnum<MCVanillaMaterial, Concrete> implements AbstractionObject {
	...
	public enum MCVanillaMaterial {
		...
		// 26.2 additions
		CHISELED_CINNABAR(MCVersion.MC26_2),
		CHISELED_SULFUR(MCVersion.MC26_2),
		CINNABAR(MCVersion.MC26_2),
		CINNABAR_BRICK_SLAB(MCVersion.MC26_2),
		CINNABAR_BRICK_STAIRS(MCVersion.MC26_2),
		CINNABAR_BRICK_WALL(MCVersion.MC26_2),
		CINNABAR_BRICKS(MCVersion.MC26_2),
		CINNABAR_SLAB(MCVersion.MC26_2),
		CINNABAR_STAIRS(MCVersion.MC26_2),
		CINNABAR_WALL(MCVersion.MC26_2),
		MUSIC_DISC_BOUNCE(MCVersion.MC26_2),
		POLISHED_CINNABAR(MCVersion.MC26_2),
		POLISHED_CINNABAR_SLAB(MCVersion.MC26_2),
		POLISHED_CINNABAR_STAIRS(MCVersion.MC26_2),
		POLISHED_CINNABAR_WALL(MCVersion.MC26_2),
		POLISHED_SULFUR(MCVersion.MC26_2),
		POLISHED_SULFUR_SLAB(MCVersion.MC26_2),
		POLISHED_SULFUR_STAIRS(MCVersion.MC26_2),
		POLISHED_SULFUR_WALL(MCVersion.MC26_2),
		POTENT_SULFUR(MCVersion.MC26_2),
		SULFUR(MCVersion.MC26_2),
		SULFUR_CUBE_BUCKET(MCVersion.MC26_2),
		SULFUR_CUBE_SPAWN_EGG(MCVersion.MC26_2),
		SULFUR_BRICK_SLAB(MCVersion.MC26_2),
		SULFUR_BRICK_STAIRS(MCVersion.MC26_2),
		SULFUR_BRICK_WALL(MCVersion.MC26_2),
		SULFUR_BRICKS(MCVersion.MC26_2),
		SULFUR_SLAB(MCVersion.MC26_2),
		SULFUR_SPIKE(MCVersion.MC26_2),
		SULFUR_STAIRS(MCVersion.MC26_2),
		SULFUR_WALL(MCVersion.MC26_2);
