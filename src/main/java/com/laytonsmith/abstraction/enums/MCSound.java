...
public abstract class MCSound<Concrete> extends DynamicEnum<MCSound.MCVanillaSound, Concrete> {
	...
	public enum MCVanillaSound {
		...
		MUSIC_GAME,
		MUSIC_MENU,
		MUSIC_NETHER(MCVersion.MC1_0, MCVersion.MC1_15_X),
		UI_BUTTON_CLICK,
		...
		ENTITY_ZOMBIE_PIGMAN_AMBIENT(MCVersion.MC1_0, MCVersion.MC1_15_X),
		ENTITY_ZOMBIE_PIGMAN_ANGRY(MCVersion.MC1_0, MCVersion.MC1_15_X),
		ENTITY_ZOMBIE_PIGMAN_DEATH(MCVersion.MC1_0, MCVersion.MC1_15_X),
		ENTITY_ZOMBIE_PIGMAN_HURT(MCVersion.MC1_0, MCVersion.MC1_15_X),
		MUSIC_DISC_11,
		MUSIC_DISC_13,
		MUSIC_DISC_BLOCKS,
		MUSIC_DISC_CAT,
		...
		ITEM_SWEET_BERRIES_PICK_FROM_BUSH(MCVersion.MC1_14),
