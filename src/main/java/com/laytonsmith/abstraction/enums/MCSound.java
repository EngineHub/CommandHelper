...
public abstract class MCSound<Concrete> extends DynamicEnum<MCSound.MCVanillaSound, Concrete> {
	...
	public enum MCVanillaSound {
		...
		MUSIC_OVERWORLD_JUNGLE_AND_FOREST(MCVersion.MC1_19, MCVersion.MC1_19_X),
		...
		// 1.19.4 additions
		BLOCK_CHERRY_LEAVES_BREAK(MCVersion.MC1_19_X),
		BLOCK_CHERRY_LEAVES_FALL(MCVersion.MC1_19_X),
		BLOCK_CHERRY_LEAVES_HIT(MCVersion.MC1_19_X),
		BLOCK_CHERRY_LEAVES_PLACE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_LEAVES_STEP(MCVersion.MC1_19_X),
		BLOCK_CHERRY_SAPLING_BREAK(MCVersion.MC1_19_X),
		BLOCK_CHERRY_SAPLING_FALL(MCVersion.MC1_19_X),
		BLOCK_CHERRY_SAPLING_HIT(MCVersion.MC1_19_X),
		BLOCK_CHERRY_SAPLING_PLACE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_SAPLING_STEP(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_BREAK(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_BUTTON_CLICK_OFF(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_BUTTON_CLICK_ON(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_DOOR_CLOSE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_DOOR_OPEN(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_FALL(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_FENCE_GATE_CLOSE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_FENCE_GATE_OPEN(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HANGING_SIGN_BREAK(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HANGING_SIGN_FALL(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HANGING_SIGN_HIT(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HANGING_SIGN_PLACE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HANGING_SIGN_STEP(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_HIT(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_PLACE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_PRESSURE_PLATE_CLICK_OFF(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_PRESSURE_PLATE_CLICK_ON(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_STEP(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_TRAPDOOR_CLOSE(MCVersion.MC1_19_X),
		BLOCK_CHERRY_WOOD_TRAPDOOR_OPEN(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_BREAK(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_FALL(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_HIT(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_PLACE(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_SHATTER(MCVersion.MC1_19_X),
		BLOCK_DECORATED_POT_STEP(MCVersion.MC1_19_X),
		BLOCK_PINK_PETALS_BREAK(MCVersion.MC1_19_X),
		BLOCK_PINK_PETALS_FALL(MCVersion.MC1_19_X),
		BLOCK_PINK_PETALS_HIT(MCVersion.MC1_19_X),
		BLOCK_PINK_PETALS_PLACE(MCVersion.MC1_19_X),
		BLOCK_PINK_PETALS_STEP(MCVersion.MC1_19_X),
		BLOCK_SUSPICIOUS_SAND_BREAK(MCVersion.MC1_19_X),
		BLOCK_SUSPICIOUS_SAND_FALL(MCVersion.MC1_19_X),
		BLOCK_SUSPICIOUS_SAND_HIT(MCVersion.MC1_19_X),
		BLOCK_SUSPICIOUS_SAND_PLACE(MCVersion.MC1_19_X),
		BLOCK_SUSPICIOUS_SAND_STEP(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_DEATH(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_DIGGING(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_DIGGING_STOP(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_DROP_SEED(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_EAT(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_HAPPY(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_HURT(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_IDLE(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_SCENTING(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_SEARCHING(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_SNIFFING(MCVersion.MC1_19_X),
		ENTITY_SNIFFER_STEP(MCVersion.MC1_19_X),
		INTENTIONALLY_EMPTY(MCVersion.MC1_19_X),
		ITEM_BRUSH_BRUSHING(MCVersion.MC1_19_X, MCVersion.MC1_19_X),
		ITEM_BRUSH_BRUSH_SAND_COMPLETED(MCVersion.MC1_19_X, MCVersion.MC1_19_X),
		MUSIC_OVERWORLD_CHERRY_GROVE(MCVersion.MC1_19_X),
