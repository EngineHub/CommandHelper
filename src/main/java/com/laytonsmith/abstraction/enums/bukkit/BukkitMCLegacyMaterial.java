...
public enum BukkitMCLegacyMaterial {
	...
	private static final HashMap<Integer, BukkitMCLegacyMaterial> BY_ID = new HashMap<>();

	public static void build() {
		for(BukkitMCLegacyMaterial mat : BukkitMCLegacyMaterial.values()) {
