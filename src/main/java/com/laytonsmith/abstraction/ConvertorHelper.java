...
/**
 * Some methods in Convertor can be abstract regardless of the server implementation, and so can therefore be abstracted
 * out. However, since Convertor is an interface, a helper is here, and subclasses can just call these static methods
 * directly.
 */
