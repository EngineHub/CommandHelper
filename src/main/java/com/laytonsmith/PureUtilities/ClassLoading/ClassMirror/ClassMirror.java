...
public class ClassMirror<T> implements Serializable {
	 ...
	 * class, this method will throw an IllegalArgumentException
	 */
	...
	/**
	 * Returns the methods in this class. This traverses the parent Object heirarchy if the methods are apart of the
	...
	/**
	 * Returns the method, given by name. This traverses the parent Object heirarchy if the methods are apart of the
	 * visible interface, as well as private methods in this class itself.
	 *
	 * @param name
	 * @param params
	...
	protected static class ClassInfo<T> implements Serializable {
		...
		/**
		 * Maps inherited classes to the generic parameters passed along to the inhereted class. For instance, if we
		 * have class Base implements A<Integer, Long>, B<String> {...} then this object would contain {A: [Integer,
		 * Long], B: [String]}
		 */
