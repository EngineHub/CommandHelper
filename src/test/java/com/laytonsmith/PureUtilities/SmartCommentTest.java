...
public class SmartCommentTest {
	...
	@Test public void testSimpleFormatting() {
		SmartComment c = new SmartComment(
				  "/**\n"
				+ " * This is a comment\n"
				+ " * with a  newline \n"
	...
	@Test public void testGetAnnotations(){
		SmartComment c = new SmartComment(
				  "/**\n"
				+ " * This is a comment\n"
				+ " * with a  newline \n"
	...
	@Test public void testEmbeddedAnnotations(){
	...
	@Test public void testEmbeddedAnnotationsInAnnotations(){
		Map<String, SmartComment.Replacement> reps = new HashMap<String, SmartComment.Replacement>();
		reps.put("code", new SmartComment.Replacement() {
