...
//    }
    ...
    @Test
    public void testMultimatch1() throws DataSourceException {
        assertEquals(getSet("yml://yes.yml"), getConnections("a.b.c", "a.**=yml://yes.yml"));
    }

    @Test
    public void testMultimatch2() throws DataSourceException {
     ...
     * @param value
     */
    private void fakeNetwork(String src, String... values) throws DataSourceException, URISyntaxException, ReadOnlyException, IOException {
    ...
    public SortedSet<String> getConnections(String key, String... mapping) throws DataSourceException {
