...
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCBiomeType;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCDifficulty;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCDyeColor;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCEntityType;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCOcelotType;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCProfession;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCSkeletonType;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCSound;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCTreeType;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCWorldEnvironment;
import com.laytonsmith.abstraction.bukkit.enums.BukkitMCWorldType;
        ...
        try {
            switch (name) {
                ...
                case MCMobs.PIG:
                    mobType = Pig.class;
                    break;
                case MCMobs.PIGZOMBIE:
                    mobType = PigZombie.class;
                    break;
                case MCMobs.SHEEP:
                    mobType = Sheep.class;
                    break;
                case MCMobs.SKELETON:
                ...
                case MCMobs.ZOMBIE:
                    ...
                    break;
                case MCMobs.CAVESPIDER:
                    mobType = CaveSpider.class;
                    break;
                case MCMobs.ENDERMAN:
                    mobType = Enderman.class;
                    break;
                case MCMobs.SILVERFISH:
                    mobType = Silverfish.class;
                    break;
                case MCMobs.BLAZE:
                    mobType = Blaze.class;
                    break;
                case MCMobs.VILLAGER:
                    mobType = Villager.class;
                    break;
                case MCMobs.ENDERDRAGON:
                    mobType = EnderDragon.class;
                    break;
                case MCMobs.MAGMACUBE:
                    mobType = MagmaCube.class;
                    break;
                case MCMobs.MOOSHROOM:
                    mobType = MushroomCow.class;
                    break;
                case MCMobs.SPIDERJOCKEY:
                    mobType = Spider.class;
                    break;
                case MCMobs.GIANT:
					mobType = Giant.class;
                    break;
                case MCMobs.SNOWGOLEM:
                    mobType = Snowman.class;
                    break;
                case MCMobs.OCELOT:
                    mobType = Ocelot.class;
                    break;
                case MCMobs.IRONGOLEM:
				...
				case MCMobs.HORSE:
					mobType = Horse.class;
					break;
				case MCMobs.ENDERMITE:
					mobType = Endermite.class;
					break;
				case MCMobs.GUARDIAN:
				...
				if(((BukkitMCEntity)e).getHandle() instanceof Wolf){
					...
					for (String type : subTypes) {
						try {
							...
							switch (wtype) {
							case MCWolfType.ANGRY:
								w.setAngry(true);
								break;
							case MCWolfType.TAMED:
								w.setTamed(true);
								break;
							default:
								break;
				...
				if(((BukkitMCEntity)e).getHandle() instanceof Zombie){
					...
					for (String type : subTypes) {
						try {
							...
							switch (ztype) {
								case MCZombieType.BABY:
									z.setBaby(true);
									break;
								case MCZombieType.VILLAGER:
									z.setVillager(true);
									break;
							}
						} catch (IllegalArgumentException ex){
